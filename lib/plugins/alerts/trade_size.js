...
class TradeSizeAlertsPlugin extends Plugin {
  ...
  constructor (host) {
    ...
    this.getHost().subscribeSetting(SETTING, (value) => {
       ...
       */
      this.emitSync('tradeSizeAlertThresholdUpdated', { value })
    })
  }

  /**
   * Returns the minimum trade size alerting threshold; attached as a terminal
   * method.
   *
  ...
  /**
   * Update the minimum trade size alerting threshold; attached as a terminal
   * method.
   *
