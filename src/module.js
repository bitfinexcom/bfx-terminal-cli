...
class Module {
  ...
  constructor (id, {
    ...
    this.asyncHostMethods = asyncHostMethods || []
  ...
  /**
   * Fetch the list of host method names provided by this module
   *
   * @returns {string[]} methods
   */
  getHostMethods () {
    return this.hostMethods
  }

  /**
   * Fetch the list of async host method names provided by this module
   *
   * @returns {string[]} methods
   */
  getAsyncHostMethods () {
    return this.asyncHostMethods
  }
